...
\begin{enumerate}
	...
	\end{lstlisting}
	\item Obsahová část - vše co se nenachází v~jednom z~těchto tagů je HTML reprezentace dané stránky, nejedná se však o čisté HTML ale jeho obohacenou verzi. Jako v~podobných frameworcích je možné přidávat \uv{event listenery} na jednotlivé elementy, podmínkově zobrazovat, pracovat s~asynchroním kódem nebo dokonce \uv{svazovat} element či hodnotu elementu s~proměnou ve scriptové části.
